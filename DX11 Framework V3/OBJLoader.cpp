...
MeshData OBJLoader::LoadTerrain(int row, int col, float dx, float dz, bool heightmap, ID3D11Device * pd3dDevice)
{
	MeshData _meshData;
...
vector<SimpleVertex> OBJLoader::LoadHeightmap(string filename, vector<SimpleVertex> planeVertex, int width, int height)
{
